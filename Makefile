...
#C_SOURCES 	= 	main.c frac.c randomz.c randqueue.c getopt.c generate_binary.c generate_mass.c make_mass.c scale.c quick_sort_widx.c output.c quick_sort.c quick_select.c
